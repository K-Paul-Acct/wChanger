setting = 'Для настройки смены названия беседы введи, разделяя вертикальной чертой "@wchanger Название чётной недели | Название нечётной недели" для вашей беседы.'
